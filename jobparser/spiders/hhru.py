...
class HhruSpider(scrapy.Spider):
    ...
    start_urls = [
        'https://izhevsk.hh.ru/search/vacancy?area=1&search_field=name&search_field=company_name&search_field=description&text=python&items_on_page=20&no_magic=true&L_save_area=true',
